...
namespace Kingdoms
{
	...
	{
		// Token: 0x060011EC RID: 4588 RVA: 0x0012CCF4 File Offset: 0x0012AEF4
		public FormationPanel()
		{
			base.SetStyle(ControlStyles.UserPaint | ControlStyles.AllPaintingInWmPaint | ControlStyles.OptimizedDoubleBuffer, true);
		}

		// Token: 0x060011ED RID: 4589 RVA: 0x0012CE94 File Offset: 0x0012B094
		public void init(FormationPopup parent)
		{
			this.m_parent = parent;
			base.Size = this.m_parent.Size;
			this.BackColor = global::ARGBColors.Transparent;
			base.addControl(new CustomSelfDrawPanel.CSDImage
			{
				Alpha = 0.1f,
				Image = GFXLibrary.formations_img,
				Scale = 5.0,
				Position = new Point(0, 0),
				Size = base.Size
			});
			this.manageLabel.Text = SK.Text("Formations_Manage_Box", "Manage Formations");
			this.manageLabel.Color = global::ARGBColors.White;
			this.manageLabel.DropShadowColor = global::ARGBColors.Black;
			this.manageLabel.Position = new Point(base.Width / 3, 5);
			this.manageLabel.Size = new Size(base.Width / 3, 24);
			...
			this.storedLabel.Color = global::ARGBColors.White;
			this.storedLabel.DropShadowColor = global::ARGBColors.Black;
			this.storedLabel.Position = new Point(base.Width / 3, 25);
			this.storedLabel.Size = new Size(base.Width / 3, 24);
			...
			this.storedList.Position = new Point(base.Width / 2 - this.storedList.Width / 2, 45);
			...
			this.loadButton.ImageNorm = GFXLibrary.button_132_normal;
			this.loadButton.ImageOver = GFXLibrary.button_132_over;
			this.loadButton.ImageClick = GFXLibrary.button_132_in;
			...
			this.deleteButton.ImageNorm = GFXLibrary.button_132_normal;
			this.deleteButton.ImageOver = GFXLibrary.button_132_over;
			this.deleteButton.ImageClick = GFXLibrary.button_132_in;
			...
			this.deleteButton.Text.Color = global::ARGBColors.Black;
			...
			this.renameButton.Text.Color = global::ARGBColors.Black;
			...
			this.clearButton.ImageNorm = GFXLibrary.button_132_normal;
			this.clearButton.ImageOver = GFXLibrary.button_132_over;
			this.clearButton.ImageClick = GFXLibrary.button_132_in;
			...
			this.clearButton.Text.Color = global::ARGBColors.Black;
			...
			this.totalsButton.ImageNorm = GFXLibrary.button_132_normal;
			this.totalsButton.ImageOver = GFXLibrary.button_132_over;
			this.totalsButton.ImageClick = GFXLibrary.button_132_in;
			...
			this.totalsButton.Text.Color = global::ARGBColors.Black;
			...
			this.formationImage.Image = GFXLibrary.formations_img;
			...
			this.createLabel.Color = global::ARGBColors.White;
			this.createLabel.DropShadowColor = global::ARGBColors.Black;
			...
			this.createNameLabel.Color = global::ARGBColors.White;
			this.createNameLabel.DropShadowColor = global::ARGBColors.Black;
			...
			this.createButton.ImageNorm = GFXLibrary.button_132_normal;
			this.createButton.ImageOver = GFXLibrary.button_132_over;
			this.createButton.ImageClick = GFXLibrary.button_132_in;
			...
			this.castlePlacePeasantButton.ImageOver = GFXLibrary.r_building_miltary_peasent;
			...
			this.castlePlaceArcherButton.ImageOver = GFXLibrary.r_building_miltary_archer;
			...
			this.castlePlacePikemanButton.ImageOver = GFXLibrary.r_building_miltary_pikemen;
			...
			this.castlePlaceSwordsmanButton.ImageOver = GFXLibrary.r_building_miltary_swordsman;
			...
			this.castlePlaceCatapultButton.ImageOver = GFXLibrary.r_building_miltary_catapult;
			...
			this.castlePlaceCaptainButton.ImageOver = GFXLibrary.r_building_miltary_captain_normal;
			...
			this.selectedTitleLabel.Color = global::ARGBColors.White;
			this.selectedTitleLabel.DropShadowColor = global::ARGBColors.Black;
			this.selectedTitleLabel.Position = new Point(2 * base.Width / 3, this.manageLabel.Y);
			this.selectedTitleLabel.Size = new Size(base.Width / 3, 24);
			...
			this.selectedTroopCountLabel.Color = global::ARGBColors.White;
			this.selectedTroopCountLabel.DropShadowColor = global::ARGBColors.Black;
			this.selectedTroopCountLabel.Position = new Point(2 * base.Width / 3, this.storedLabel.Y);
			this.selectedTroopCountLabel.Size = new Size(base.Width / 3, 24);
		...
		// Token: 0x060011EE RID: 4590 RVA: 0x00007CE0 File Offset: 0x00005EE0
		private void closeClick(CustomSelfDrawPanel.CSDListItem item)
		{
		}

		// Token: 0x060011EF RID: 4591 RVA: 0x000137F6 File Offset: 0x000119F6
		...
		// Token: 0x060011F0 RID: 4592 RVA: 0x0012E2DC File Offset: 0x0012C4DC
		private void loadNames()
		{
			...
			foreach (string text in array)
			{
				...
				if (array3.Length >= 2 && !(array3[0].ToLowerInvariant() != "attacksetup"))
				{
					...
					csdlistItem.Text = text2;
					this.formationNames.Add(csdlistItem);
				}
			}
			this.storedList.populate(this.formationNames);
		}

		// Token: 0x060011F1 RID: 4593 RVA: 0x0012E3AC File Offset: 0x0012C5AC
		private void updateTotals(CustomSelfDrawPanel.CSDListItem current)
		{
			...
			CustomSelfDrawPanel.CSDLabel csdlabel = this.selectedTroopCountLabel;
			csdlabel.Text = csdlabel.Text + " - " + count.ToString();
		...
		// Token: 0x060011F2 RID: 4594 RVA: 0x0012E670 File Offset: 0x0012C870
		private void initTotals()
		{
			...
			int num7 = currentAttackSetup.Length;
			for (int i = 0; i < num7; i++)
			{
				switch (currentAttackSetup[i].elementType)
				{
				case 90:
					num++;
					break;
			...
			this.selectedTroopCountLabel.Text = SK.Text("Formations_Troop_Count", "Total Troops");
			CustomSelfDrawPanel.CSDLabel csdlabel = this.selectedTroopCountLabel;
			csdlabel.Text = csdlabel.Text + " - " + num7.ToString();
			this.castlePlacePeasantLabel.Text = num.ToString();
			this.castlePlaceArcherLabel.Text = num2.ToString();
			this.castlePlacePikemanLabel.Text = num3.ToString();
			this.castlePlaceSwordsmanLabel.Text = num4.ToString();
		...
		// Token: 0x060011F3 RID: 4595 RVA: 0x0012E808 File Offset: 0x0012CA08
		...
		// Token: 0x060011F4 RID: 4596 RVA: 0x0012E868 File Offset: 0x0012CA68
		private void SharedCreateCode()
		{
			...
			{
				CustomSelfDrawPanel.CSDListItem csdlistItem = new CustomSelfDrawPanel.CSDListItem();
				csdlistItem.Text = this.saveName;
				this.formationNames.Add(csdlistItem);
				this.storedList.populate(this.formationNames);
			}
			this.loadNames();
		...
		// Token: 0x060011F5 RID: 4597 RVA: 0x0001381A File Offset: 0x00011A1A
		...
		// Token: 0x060011F6 RID: 4598 RVA: 0x0001382D File Offset: 0x00011A2D
		...
		// Token: 0x060011F7 RID: 4599 RVA: 0x00013856 File Offset: 0x00011A56
		...
		// Token: 0x060011F8 RID: 4600 RVA: 0x00013891 File Offset: 0x00011A91
		...
		// Token: 0x060011F9 RID: 4601 RVA: 0x0012E8DC File Offset: 0x0012CADC
		...
		// Token: 0x060011FA RID: 4602 RVA: 0x000138CD File Offset: 0x00011ACD
		...
		// Token: 0x060011FB RID: 4603 RVA: 0x000138E0 File Offset: 0x00011AE0
		...
		// Token: 0x060011FC RID: 4604 RVA: 0x0012E974 File Offset: 0x0012CB74
		...
		// Token: 0x060011FD RID: 4605 RVA: 0x00013909 File Offset: 0x00011B09
		private void clearClick()
		{
			GameEngine.Instance.CastleAttackerSetup.deleteAllAttackers();
		}

		// Token: 0x060011FE RID: 4606 RVA: 0x0001391A File Offset: 0x00011B1A
		private void totalsClick()
		{
			this.initTotals();
		}

		// Token: 0x060011FF RID: 4607 RVA: 0x00013922 File Offset: 0x00011B22
		...
		// Token: 0x06001200 RID: 4608 RVA: 0x00013960 File Offset: 0x00011B60
		...
		// Token: 0x06001201 RID: 4609 RVA: 0x00007CE0 File Offset: 0x00005EE0
